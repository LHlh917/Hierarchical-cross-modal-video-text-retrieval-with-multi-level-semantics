...
class MSVDDataset(Dataset):
    ...
    def __init__(self, config: Config, split_type = 'train', img_transforms=None):
        ...
        db_file = '/opt/data/private/LH/LH-v2t/xpool1/data/MSVD/captions_msvd_test1234.json'
        test_file = '/opt/data/private/LH/LH-v2t/xpool1/data/MSVD/test_list_2.txt'
        train_file = '/opt/data/private/LH/LH-v2t/xpool1/data/MSVD/train_list.txt'
