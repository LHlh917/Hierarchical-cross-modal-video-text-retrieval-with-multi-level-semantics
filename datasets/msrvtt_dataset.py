...
class MSRVTTDataset(Dataset):
    ...
    def __init__(self, config: Config, split_type = 'train', img_transforms=None):
        ...
        db_file = '/opt/data/private/LH/xpool-main/data/MSRVTT/MSRVTT_data.json'
        test_csv = '/opt/data/private/LH/xpool-main/data/MSRVTT/MSRVTT_JSFUSION_test.csv'

        if config.msrvtt_train_file == '7k':
            train_csv = '/opt/data/private/LH/xpool-main/data/MSRVTT/MSRVTT_train.7k.csv'
        else:
            train_csv = '/opt/data/private/LH/xpool-main/data/MSRVTT/MSRVTT_train.9k.csv'
    ...
    def _get_vidpath_and_nouns_by_index(self, video_id, caption):
        ...
        for word, pos in pos_tags:
            ...
            #     words.append(lemma) 
        new_sentence = "a photo of "  + " ".join(words)
